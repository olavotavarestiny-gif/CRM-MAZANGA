...
| WhatsApp | `WHATSAPP_ACCESS_TOKEN`, `WHATSAPP_API_VERSION`, `WHATSAPP_PHONE_NUMBER_ID`, `WHATSAPP_OWNER_EMAIL`, `WEBHOOK_VERIFY_TOKEN`, `WABA_ID` |
...
| Ziett | `ZIETT_ENABLE`, `ZIETT_BASE_URL`, `ZIETT_API_KEY`, `ZIETT_DEFAULT_REMITTER_ID`, `ZIETT_DEFAULT_CHANNEL`, `ZIETT_DEFAULT_COUNTRY`, `ZIETT_TEST_ALLOWED_RECIPIENTS` |
