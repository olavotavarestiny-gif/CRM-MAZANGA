...
- `docs/standards/engineering-standards.md` para regras de engenharia e qualidade
- `docs/overview/developer-evaluation.md` para avaliação técnica rápida
- `docs/product/kukugest.md` como guia estrutural e lógico do sistema
...
- `docs/overview/developer-evaluation.md`
