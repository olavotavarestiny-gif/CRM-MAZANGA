...
// [LOCAL-ONLY — não commitar] Modo de workspace da conta de demonstração.
// NEXT_PUBLIC_DEV_WORKSPACE_MODE=comercio mostra Caixa/POS, Produtos e Faturação;
// o valor por omissão ('servicos') mostra o CRM completo.
