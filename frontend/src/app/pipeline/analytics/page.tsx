...
export default function PipelineAnalyticsPage() {
  ...
  }, [currentUser?.workspaceMode, router]);
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <div className="flex items-center gap-2">
            <Link href="/pipeline" className="text-sm font-medium text-[#6b7e9a] hover:text-[#0A2540]">
              Pipeline
            </Link>
            <span className="text-sm text-[#c2c9d3]">/</span>
            <span className="text-sm font-medium text-[#0A2540]">Analytics</span>
          </div>
          <h1 className="mt-2 text-3xl font-bold">Analytics do Pipeline</h1>
