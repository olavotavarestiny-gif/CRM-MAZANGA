...
import {
  Users, Trash2, Eye, Plus, Search, ChevronDown,
  Shield, RefreshCw,
} from 'lucide-react';
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-[#6b7e9a]">{orgs.length} organizações</p>
          </div>
        </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[#dde3ec] bg-[#f8fafc]">
                <th className="text-left px-4 py-3 font-semibold text-[#0A2540]">Organização</th>
            ...
            <tbody>
              {filtered.map((org) => (
                <tr key={org.id} className="border-b border-[#dde3ec] last:border-0 hover:bg-[#f8fafc] transition-colors">
