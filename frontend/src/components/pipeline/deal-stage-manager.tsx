...
export default function DealStageManager({
  open,
  onClose,
}: {
  open: boolean;
    ...
    <>
      <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
        <DialogContent className="max-w-md bg-white text-[#0A2540]">
          <DialogHeader>
            <DialogTitle className="text-[#0A2540]">Gerir Fases das Negociações</DialogTitle>
          </DialogHeader>
          ...
          <div className="border-t border-[#E2E8F0] pt-4 space-y-3">
            <p className="text-sm font-semibold text-[#0A2540]">Adicionar nova fase</p>
            <Input
      ...
      <Dialog open={!!editingStage} onOpenChange={(o) => !o && setEditingStage(null)}>
        <DialogContent className="max-w-sm bg-white text-[#0A2540]">
          <DialogHeader>
            <DialogTitle className="text-[#0A2540]">Editar Fase</DialogTitle>
          </DialogHeader>
      ...
      <Dialog open={!!deletingStage} onOpenChange={(o) => !o && setDeletingStage(null)}>
        <DialogContent className="max-w-sm bg-white text-[#0A2540]">
          <DialogHeader>
            <DialogTitle className="text-[#0A2540]">Eliminar Fase</DialogTitle>
          </DialogHeader>
          <p className="text-sm text-[#6b7e9a]">
            Tens a certeza que queres eliminar a fase{' '}
            <strong className="text-[#0A2540]">{deletingStage?.name}</strong>?
            As negociações nesta fase serão movidas para a primeira fase disponível.
          </p>
          <div className="flex gap-2 justify-end pt-2">
